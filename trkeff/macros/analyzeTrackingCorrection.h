  ...
  jetPtMin(jPtMin)
{
 ...
 //  const Int_t numHigtPtBins=18;
   Double_t highPtBins[] = {2.0, 2.5, 3.0, 4., 5., 6., 8., 10.,12.,15.,20.,25.,30.,45.,60.,80.,100., 140.,200.,300.,500.};
...
//    Float_t jBins[numJetBins+1] = {0,20,40,60,80,120,160,200,250,500,1000};
 //  const Int_t numJetBins=5;
   Float_t jBins[] = {0,jetPtMin,80, 120, 300, 500, 1000};
   const Int_t numJetBins = sizeof(jBins)/sizeof(Double_t)-1 ;
