...
//       trackCorrections.push_back(new TrackingCorrections("Forest2STAv12","Forest2_MergedGeneral_j2"));
      ...
      for(int i = 0; i < trackCorrections.size(); ++i){
          if (!pp) {
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14fXSec/IterTrkCorrv14fXSec_hy18dj80to100_akPu3PF_100_-1_-1000_genJetMode0.root",80);
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14fXSec/IterTrkCorrv14fXSec_hy18dj100to170_akPu3PF_100_-1_-1000_genJetMode0.root",100);
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14fXSec/IterTrkCorrv14fXSec_hy18dj170to200_akPu3PF_100_-1_-1000_genJetMode0.root",170);
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14fXSec/IterTrkCorrv14fXSec_hy18dj200to250_akPu3PF_100_-1_-1000_genJetMode0.root",200);
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14fXSec/IterTrkCorrv14fXSec_hy18dj250to300_akPu3PF_100_-1_-1000_genJetMode0.root",250);
           trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14fXSec/IterTrkCorrv14fXSec_hy18dj300to9999_akPu3PF_100_-1_-1000_genJetMode0.root",300);
/*
  ...
  */            // v12: frozen for preapproval
     ...
     /*      trackCorrections[i]->AddSample("trkcorr/IterTrkCorrv14XSec_pp/TrkCorrtest_ppSigdj50_ak3PF_100_-1_-1000_genJetMode0.root",50);
           ...
           trackCorrections[i]->AddSample("TrkCorrtest_ppHITracking_Sigdj80_ak3PF_100_-1_-1000_genJetMode0.root", 80) ; 
           trackCorrections[i]->AddSample("TrkCorrtest_ppHITracking_Sigdj120_ak3PF_100_-1_-1000_genJetMode0.root", 120) ; 
           trackCorrections[i]->AddSample("TrkCorrtest_ppHITracking_Sigdj170_ak3PF_100_-1_-1000_genJetMode0.root", 170) ; 
           trackCorrections[i]->AddSample("TrkCorrtest_ppHITracking_Sigdj220_ak3PF_100_-1_-1000_genJetMode0.root", 220) ; 
           trackCorrections[i]->AddSample("TrkCorrtest_ppHITracking_Sigdj280_ak3PF_100_-1_-1000_genJetMode0.root", 280) ; 
        }
