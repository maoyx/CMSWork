...
//static const int nbins_truth = 24;
static const double boundaries_truth[] = {
//  0,5,10,15,20,25,30,35,40,45,50,55, 60,70,80,90,110,130,170,250
// 0,5,10,15,20,25,30,40,50,60,70,80,90,100, 110,120,140,160,180,200,220,260,300,350,400,500
3, 4, 5, 7, 9, 12, 15, 18, 22, 27, 33, 39, 47, 55, 64,74, 84, 97, 114, 133, 153, 174, 196, 220, 245, 272, 300, 429, 692, 1000
};
static const int nbins_truth = sizeof(boundaries_truth)/sizeof(Double_t)-1;
// Measurement binning
//static const int nbins_rec = 19;
//static const int nbins_rec = 24;
...
//static const int nbins_recrebin = 15;
//static const int nbins_recrebin = 21;
static const double boundaries_recrebin[] = {
//  0,5,10,15,20,25,30,35,40,45,50,55, 60,70,80,90,110,130,170,250
  //0,5,10,15,20,25,30,35,40,50,60,70,80,90,100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250
//  0,15,30,40,50,60,75, 95, 120, 150, 180, 220, 260, 300, 400, 500
//0., 10., 20., 30., 40., 50., 65., 75., 85., 95., 110., 120., 140., 160., 180., 200., 220., 260., 300., 350., 400.,500
//0,5,10,15,20,25,30,40,50,60,70,80,90,100, 110,120,140,160,180,200,220,260,300,350, 400,500
// 0,5,10,15,20,25,30,40,50,60,65,75,85,95,100,110,120,140,160,180,200,220,260,300,350,400,500
3, 4, 5, 7, 9, 12, 15, 18, 22, 27, 33, 39, 47, 55, 64,74, 84, 97, 114, 133, 153, 174, 196, 220, 245, 272, 300, 429, 692, 1000
};
static const int nbins_recrebin = sizeof(boundaries_recrebin)/sizeof(Double_t)-1;

//static const int nbins_recrebinM = 12;
//static const int nbins_recrebinM = 15;
//static const int nbins_recrebinM = 21;
...
static const char *algoName[nAlgos] = { "", "akPu4PF", "ak3PF", "akPu3PF", "ak4PF", "ak5PF", "akPu3Calo", "akPu4Calo" };
...
//hReco = new TH1F(Form("Reco_cent%d",i), Form(" RooUnfold Reconstructed_cent1%d",i), nbins_rec, boundaries_rec); //Reco
//hRecoBinByBin = new TH1F(Form("RecoBinByBin_cent%d",i), Form(" RooUnfold ReconstructedBinByBin_cent1%d",i), nbins_rec, boundaries_rec); //Reco
...
//hResponse = new TH2F(Form("hResponse_cent%d",i), Form(" Response Matrix Normalized;Genjet p_{T};Recojet p_{T}"), nbins_truth, boundaries_truth,nbins_rec, boundaries_rec); //Matrix
