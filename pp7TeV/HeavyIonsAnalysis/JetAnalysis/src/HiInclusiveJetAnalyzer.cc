  ...
  geo(0)
{
  ...
  EBSrc_ = iConfig.getUntrackedParameter<edm::InputTag>("reducedEcalRecHitsEB",edm::InputTag("ecalRecHit","EcalRecHitsEB"));
  EESrc_ = iConfig.getUntrackedParameter<edm::InputTag>("reducedEcalRecHitsEE",edm::InputTag("ecalRecHit","EcalRecHitsEE"));
  HcalRecHitHFSrc_ = iConfig.getUntrackedParameter<edm::InputTag>("reducedHcalRecHits",edm::InputTag("hfreco"));
  HcalRecHitHBHESrc_ = iConfig.getUntrackedParameter<edm::InputTag>("reducedHcalRecHits",edm::InputTag("hbhereco"));
