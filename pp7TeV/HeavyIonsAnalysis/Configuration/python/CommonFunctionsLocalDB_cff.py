...
def overrideJEC_DATA_pp8TeV(process):
    process.GlobalTag.toGet.extend([
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_DATA_AK1PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_DATA.db"),
                 label = cms.untracked.string("AK1PF")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_DATA_AK2PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_DATA.db"),
        ...
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_DATA_AK5PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_DATA.db"),
        ...
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_DATA_AK1PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_DATA.db"),
                 label = cms.untracked.string("AK1Calo")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_DATA_AK2PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_DATA.db"),
                 label = cms.untracked.string("AK2Calo")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_DATA_AK3PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_DATA.db"),
        ...
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_DATA_AK5Calo"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_DATA.db"),
                 label = cms.untracked.string("AK5Calo")
             ),
    ])
    return process
def overrideJEC_MC_pp8TeV(process):
    process.GlobalTag.toGet.extend([
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_MC_AK1PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_MC.db"),
                 label = cms.untracked.string("AK1PF")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_MC_AK2PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_MC.db"),
                 label = cms.untracked.string("AK2PF")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_MC_AK3PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_MC.db"),
                 label = cms.untracked.string("AK3PF")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_MC_AK4PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_MC.db"),
                 label = cms.untracked.string("AK4PF")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_MC_AK5PF"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_MC.db"),
                # tag = cms.string("JetCorrectorParametersCollection_Winter14_V5_MC_AK5PF"),
                # connect = cms.untracked.string("sqlite_file:Winter14_V5_MC.db"),
                 label = cms.untracked.string("AK5PF")
             ),
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_MC_AK1PF"),
        ...
        cms.PSet(record = cms.string("JetCorrectionsRecord"),
                 tag = cms.string("JetCorrectorParametersCollection_CSA14_V4_MC_AK5Calo"),
                 connect = cms.untracked.string("sqlite_file:CSA14_V4_MC.db"),
